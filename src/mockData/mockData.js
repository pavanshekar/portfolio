...
export const languagesIconsMockData = [
  ...
  { id: 14, skill: 'TailwindCSS', icon: tailwindCSS },
  { id: 15, skill: 'NumPy', icon: numPy },
  { id: 16, skill: 'Pandas', icon: pandas },
  { id: 17, skill: 'SciKit-Learn', icon: sciKitLearn },
  { id: 18, skill: 'MatPlotLib', icon: matPlotLib },
  { id: 19, skill: 'Seaborn', icon: seaborn },
  { id: 20, skill: 'OpenCV', icon: openCV },
  { id: 21, skill: 'Jest', icon: jest },
  { id: 22, skill: 'Enzyme', icon: enzyme },
  { id: 23, skill: 'Protractor', icon: protractor },
  { id: 24, skill: 'Jasmine', icon: jasmine },
  { id: 25, skill: 'Mocha', icon: mocha },
  { id: 26, skill: 'Chai', icon: chai },
  { id: 27, skill: 'MySQL', icon: mysql },
  { id: 28, skill: 'MongoDB', icon: mongodb },
  { id: 29, skill: 'Hibernate', icon: hibernate },
  { id: 30, skill: 'Sequelize', icon: sequelize },
  { id: 31, skill: 'Git', icon: git },
  { id: 32, skill: 'Heroku', icon: heroku },
  { id: 33, skill: 'Anaconda', icon: anaconda },
  { id: 34, skill: 'Jupyter Notebook', icon: jupyter },
  { id: 35, skill: 'VS Code', icon: vscode },
  { id: 36, skill: 'Eclipse', icon: eclipse },
